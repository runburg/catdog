...
region_radius = 1.0
galactic_plane = 18
generate_full_sky_cones(region_radius, galactic_plane=galactic_plane, hemi='both', output_directory=cone_directory)
...
''')
        outfile.write(f"python3 -u main.py {infile} {int(galactic_plane)}")
